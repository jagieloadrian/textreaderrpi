...
Write user-facing documentation for the Helm chart that covers installation, configuration, hardware access, troubleshooting, and example deployment scenarios.
